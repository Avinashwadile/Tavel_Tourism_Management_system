...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    JTextField tfnumber,tfcontry,tfaddress,tfemail,tfphone;
    JComboBox comboid;
    ...
    AddCustomer(String username){
        ...
        comboid=new JComboBox(new String[]{ "Passport","Aadhar Card","Pan Card","Voting Card"});
        ...
        tfcontry.setBounds(220,250,150,25);
        add(tfcontry);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            String country=tfcontry.getText();
